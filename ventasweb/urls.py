...
urlpatterns = [
    ...
    # URLs de Año Fiscal - DESHABILITADAS (Se crea automáticamente cuando se necesita)
    ...
    path('facturas/cliente/<int:cliente_id>/', views.facturas_cliente, name='facturas_cliente'),
