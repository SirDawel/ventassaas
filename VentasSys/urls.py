"""
URL configuration for VentasSys project.
"""
...
urlpatterns = [
    ...
    # =====================================================================================
    # MÓDULOS ACADÉMICOS DESHABILITADOS - Sistema de Ventas no usa estudiantes/cursos
    # =====================================================================================
  ...
  #  ______________usuario____________________
    # NOTA: URLs de usuarios ahora están en ventasweb/urls.py (incluido abajo)
...
#_______________persona___________________________________________________
    ...
    # =====================================================================================
    # URLs para Año Fiscal - DESHABILITADO (Se crea automáticamente cuando se necesita)
    # =====================================================================================
    ...
    # =====================================================================================
    # URLs para Cursos - DESHABILITADO (Sistema de Ventas)
    # =====================================================================================
    ...
    # =====================================================================================
    # URLs para Materias - DESHABILITADO (Sistema de Ventas)
    # =====================================================================================
    ...
    # Incluir las demás URLs de ventasweb
